                ...
                <div class="content">
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <form class="form-horizontal row-fluid" action="<?php echo url_for('system/group') ?>" method="POST">
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">用户组名称</label>
                                    <div class="controls">
                                        <input type="text" id="group_name" name="group_name" placeholder="请输入用户组名称..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
